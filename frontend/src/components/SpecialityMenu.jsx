...
const SpecialityMenu = () => {
    return (
        <div id='speciality' className='flex flex-col items-center gap-4 py-16 text-[#262626]'>
            ...
            <p className='sm:w-1/3 text-center text-sm'>Explore a wide range of medical specialties and connect with experienced doctors tailored to your healthcare needs.</p>
